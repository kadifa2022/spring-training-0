...
public interface MovieCinemaRepository extends JpaRepository<MovieCinema, Long> {
    ...
    List<MovieCinema> findAllByMovieNameContaining(String nme);
    ...
    @Query("SELECT mc FROM MovieCinema mc WHERE mc.dateTime > ?1")//something
    ...
    @Query(value = "SELECT * FROM movie_cinema mc JOIN cinema c ON c.id=mc.cinemaid" +

...
public interface AccountRepository extends JpaRepository <Account, Long> {
    ...
    //Write a derived query to list all accounts with age lower or equal to a specific value
    ...
    //Write derived query to list all accounts where the beginning of the address contains the keyword
   ...
   //Write a native query to read all accounts that a specific value can be containable in name,address, country, state city
    ...
    @Query(value = "SELECT * FROM accunt_details WHERE age > ?1", nativeQuery = true)

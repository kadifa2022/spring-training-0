...
public interface MovieRepository extends JpaRepository<Movie, Long> {
    ...
    //Write a derived query to read a movie with name //one movie
    Optional<Movie> findByName(String Name);

    //Write a derived queries to list all movies between a range of price
    List<Movie> findAllMoviesByPriceBetween(BigDecimal price1, BigDecimal price2);

    //Write a derived query to list all movies where duration exist in the specific list of duration
    ...
    //Write a native query that return the list of movies in specific range of prices
